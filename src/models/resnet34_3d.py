...
class ResNet34_3d(nn.Module):
    def __init__(self, shortcut_type='B', no_cuda = False):
        ...
        self.layer1 = self._make_layer(self.block, 64, self.layers[0], shortcut_type)
        self.layer2 = self._make_layer(self.block, 128, self.layers[1], shortcut_type, stride=2)
        self.layer3 = self._make_layer(self.block, 256, self.layers[2], shortcut_type, stride=1, dilation=2)
