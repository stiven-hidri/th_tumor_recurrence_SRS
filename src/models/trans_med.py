...
class PatchEmbedding(nn.Module):
    def __init__(self, patch_size: int = 1, emb_size: int = 512, depth_img:int=42, n_modalities:int=2, num_channels:int=3, use_clinical_data:bool=False, out_dim_clincal_features:int=64):
