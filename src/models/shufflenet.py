...
class ShuffleNet(nn.Module):
    def __init__(self, groups=1, width_mult=1, out_dim=512):
        ...
        if groups == 1:
            ...
            raise ValueError("""{} groups is not supported for 1x1 Grouped Convolutions""".format(self.groups))
        ...
        self.final_fc = nn.Linear(out_planes[3], self.out_dim)  
