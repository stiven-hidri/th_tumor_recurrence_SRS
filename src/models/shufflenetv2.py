...
class ShuffleNetV2(nn.Module):
    def __init__(self, out_dim=512, sample_size=40, width_mult=1.5):
        ...
        if width_mult == 0.25:
            ...
            raise ValueError("not supported for 1x1 Grouped Convolutions")
        ...
        self.final_fc = nn.Sequential(
                            nn.Dropout(0.2),
                            nn.Linear(self.stage_out_channels[-1], out_dim)
                            )
