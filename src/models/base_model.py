...
class BaseModel(nn.Module):
    def __init__(self):
        ...
        self.les_dropout = nn.Dropout(0.3)
        ...
        self.dose_dropout = nn.Dropout(0.3)
        self.dose_fc2 = nn.Linear(512, 128)
        
        # Clinical input branch
        self.clinical_fc1 = nn.Linear(6, 32)
        self.clinical_fc2 = nn.Linear(32, 128)
    ...
    def forward(self, les_input, dose_input, clinical_input):
        ...
        # Clinical branch
        x = F.relu(self.clinical_fc1(clinical_input))
